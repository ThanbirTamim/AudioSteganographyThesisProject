...
{
    public static class ExistingTechnique2
    {
            ...
            try
            {
                ...
                Thread thread1 = new Thread(() =>
                {
                    ...
                    for (int i = 85; i < msgBinaryhalf + 85; i++)
                    {
                        ...
                        if (secretMesssgaeBinary.Length > messageTrackFirstHalf)
                            ltr[15] = secretMesssgaeBinary[messageTrackFirstHalf];
                        if (secretMesssgaeBinary.Length > messageTrackFirstHalf + 1)
                            ltr[14] = secretMesssgaeBinary[messageTrackFirstHalf + 1];
                        if (secretMesssgaeBinary.Length > messageTrackFirstHalf + 2)
                            ltr[13] = secretMesssgaeBinary[messageTrackFirstHalf + 2];
                        if (secretMesssgaeBinary.Length > messageTrackFirstHalf + 3)
                            ltr[12] = secretMesssgaeBinary[messageTrackFirstHalf + 3];

                        newLeftStreamValue = Convert.ToInt32(new string(ltr.ToArray()), 2) * evenodd;

                        leftStream[i] = (short)newLeftStreamValue;
                        messageTrackFirstHalf = messageTrackFirstHalf + 4;
                    }
                });
                Thread thread2 = new Thread(() =>
                {
                    ...
                    for (int i = msgBinaryhalf + 85; i < secretMesssgaeBinary.Length + 85; i++)
                    {
                        ...
                        if (secretMesssgaeBinary.Length > messageTrackSecondHalf)
                            ltr[15] = secretMesssgaeBinary[messageTrackSecondHalf];
                        if (secretMesssgaeBinary.Length > messageTrackSecondHalf + 1)
                            ltr[14] = secretMesssgaeBinary[messageTrackSecondHalf + 1];
                        if (secretMesssgaeBinary.Length > messageTrackSecondHalf + 2)
                            ltr[13] = secretMesssgaeBinary[messageTrackSecondHalf + 2];
                        if (secretMesssgaeBinary.Length > messageTrackSecondHalf + 3)
                            ltr[12] = secretMesssgaeBinary[messageTrackSecondHalf + 3];

                        newRightStreamValue = Convert.ToInt32(new string(ltr.ToArray()), 2) * evenodd;
                        rightStream[i] = (short)newRightStreamValue;
                        messageTrackSecondHalf = messageTrackSecondHalf + 4;
                    }
                });
